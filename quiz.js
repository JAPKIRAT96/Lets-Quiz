const correctAnswerIcon =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSRVaUqcNlulaw4NWGc1J-kE9O0YepBPoruxQ&usqp=CAU";
const wrongAnswerIcon =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTK8yuslv_ik4E7M_EWr_cZjxayl5GjhoD1rQ&usqp=CAU";
const warningIcon =
...
let questionsArray = [
  {
    question:
      "1. You work on a Javascript project. How do you prompt users with messages and at the same time requesting user inputs?",
    optionone: "Alert()",
    optiontwo: "Display()",
    optionthree: "Prompt()",
    optionfour: "Confirm()",
  ...
  {
    question:
      "2. Which of the following function of Array object reverses the order of the elements of an array?",
    optionone: "reverse()",
    optiontwo: "push()",
...
let counter;
let times = document.querySelector(".time-section");

var time = questionsArray.length * 20;

function starttimer(time) {
  counter = setInterval(clockTick, 1000);
}
